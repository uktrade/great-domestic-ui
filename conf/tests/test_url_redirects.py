...
redirects = [
    ...
    (
        '/transition/',
        '/international/content/invest/how-to-setup-in-the-uk/uk-transition-guidance-international-business/'
    ),
    (
    ...
    (
        '/trskorea/',
        'https://eu.eventscloud.com/korea-uk-tech-rocketship-awards-kr'
    ),
    (
        '/TRSkorea/',
        'https://eu.eventscloud.com/korea-uk-tech-rocketship-awards-kr'
